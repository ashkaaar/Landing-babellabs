            ...
            <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
                ...
                >
                    <AnimatedWords
                        title={"contact"}
                        style={
                            "flex max-w-[300px] flex-col items-start text-left text-[70px] font-extrabold uppercase leading-[1em] text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center sm:text-[120px] md:text-[150px] lg:text-center lg:text-[80px] xl:text-[270px]"
                        }
                    />
                </div>
                ...
                <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
                    ...
                    <div className="flex gap-10 text-[12px] font-bold text-[#e4ded7]  sm:gap-14 sm:text-[24px] md:gap-10 md:text-[16px] lg:gap-20 lg:text-[28px]">
                        <Link
